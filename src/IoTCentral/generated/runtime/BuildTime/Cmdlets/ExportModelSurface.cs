...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Support";
