...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime
{
    ...
    {
        Task Validate(Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.IEventListener listener);
    }
    ...
    internal static partial class Extensions
    {
        ...
        public static async Task AssertNotNull(this IEventListener instance, string parameterName, object value)
        {
            if (value == null)
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' should not be null", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertMinimumLength(this IEventListener instance, string parameterName, string value, int length)
        {
            ...
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, Message = $"Length of '{parameterName}' is less than {length}", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        ...
        public static async Task AssertRegEx(this IEventListener instance, string parameterName, string value, string regularExpression)
        {
            ...
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' does not validate against pattern /{regularExpression}/", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertEnum(this IEventListener instance, string parameterName, string value, params string[] values)
        {
            ...
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' is not one of ({values.Aggregate((c, e) => $"'{e}',{c}")}", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertObjectIsValid(this IEventListener instance, string parameterName, object inst)
        {
            await (inst as Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.IValidates)?.Validate(instance);
        }
        ...
        public static async Task AssertIsLessThan<T>(this IEventListener instance, string parameterName, T? value, T max) where T : struct, System.IComparable<T>
        {
            ...
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.IoTCentral.Runtime.Events.ValidationWarning, Message = $"Value of '{parameterName}' must be less than {max} (value is {value})", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
