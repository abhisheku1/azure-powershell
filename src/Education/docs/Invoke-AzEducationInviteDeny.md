...
online version: https://docs.microsoft.com/powershell/module/az.education/invoke-azeducationinvitedeny
schema: 2.0.0
---

# Invoke-AzEducationInviteDeny
...
### Invite (Default)
```
Invoke-AzEducationInviteDeny -BillingAccountName <String> -BillingProfileName <String>
...
### InviteViaIdentity
```
Invoke-AzEducationInviteDeny -InputObject <IEducationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
