...
online version: https://docs.microsoft.com/powershell/module/az.education/get-azeducationstudent
schema: 2.0.0
---

# Get-AzEducationStudent
...
```
Get-AzEducationStudent -BillingAccountName <String> -BillingProfileName <String> -InvoiceSectionName <String>
