...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/set-azmlworkspacebatchdeployment
schema: 2.0.0
---

# Set-AzMlWorkspaceBatchDeployment
...
```
Set-AzMlWorkspaceBatchDeployment -EndpointName <String> -Name <String> -ResourceGroupName <String>
