...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/set-azmlworkspacedatasetversion
schema: 2.0.0
---

# Set-AzMlWorkspaceDatasetVersion
...
```
Set-AzMlWorkspaceDatasetVersion -Name <String> -ResourceGroupName <String> -Version <String>
