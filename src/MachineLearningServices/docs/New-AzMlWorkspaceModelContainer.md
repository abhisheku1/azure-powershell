...
```
New-AzMlWorkspaceModelContainer -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 -Body <IModelContainerData> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzMlWorkspaceModelContainer -InputObject <IMachineLearningWorkspacesIdentity> -Body <IModelContainerData>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzMlWorkspaceModelContainer -InputObject <IMachineLearningWorkspacesIdentity> [-Description <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.IModelContainerData
...
### Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.IModelContainerData
...
BODY <IModelContainerData>: Azure Resource Manager resource envelope.
