...
```
New-AzMlWorkspaceCodeContainer -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 -Body <ICodeContainer> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzMlWorkspaceCodeContainer -InputObject <IMachineLearningWorkspacesIdentity> -Body <ICodeContainer>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20220501.ICodeContainer
...
### Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20220501.ICodeContainer
...
BODY <ICodeContainer>: Azure Resource Manager resource envelope.
