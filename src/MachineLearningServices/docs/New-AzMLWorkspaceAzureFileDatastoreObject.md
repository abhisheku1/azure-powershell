...
online version: https://docs.microsoft.com/powershell/module/az.MLWorkspace/new-AzMLWorkspaceAzureFileDatastoreObject
schema: 2.0.0
---

# New-AzMLWorkspaceAzureFileDatastoreObject
...
```
New-AzMLWorkspaceAzureFileDatastoreObject -AccountName <String> -CredentialsType <CredentialsType>
 -DatastoreType <DatastoreType> -FileShareName <String> [-Description <String>] [-Endpoint <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.AzureFileDatastore
