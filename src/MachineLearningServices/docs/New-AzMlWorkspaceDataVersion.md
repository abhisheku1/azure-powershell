...
### CreateViaIdentity
```
New-AzMlWorkspaceDataVersion -InputObject <IMachineLearningWorkspacesIdentity> -Body <IDataVersionBase>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzMlWorkspaceDataVersion -InputObject <IMachineLearningWorkspacesIdentity> -DataType <DataType>
 -DataUri <String> [-Description <String>] [-IsAnonymou] [-IsArchived] [-ResourceBaseProperty <Hashtable>]
