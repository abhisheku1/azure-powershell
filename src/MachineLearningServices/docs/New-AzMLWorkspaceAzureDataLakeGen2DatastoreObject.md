...
online version: https://docs.microsoft.com/powershell/module/az.MLWorkspace/new-AzMLWorkspaceAzureDataLakeGen2DatastoreObject
schema: 2.0.0
---

# New-AzMLWorkspaceAzureDataLakeGen2DatastoreObject
...
```
New-AzMLWorkspaceAzureDataLakeGen2DatastoreObject -AccountName <String> -CredentialsType <CredentialsType>
 -DatastoreType <DatastoreType> -Filesystem <String> [-Description <String>] [-Endpoint <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.AzureDataLakeGen2Datastore
