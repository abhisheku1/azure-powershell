...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/set-azmachinelearningworkspacescompute
schema: 2.0.0
---

# Set-AzMachineLearningWorkspacesCompute
...
```
Set-AzMachineLearningWorkspacesCompute -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
