...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/new-azmachinelearningworkspacesprivateendpointconnection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-AzMachineLearningWorkspacesPrivateEndpointConnection -InputObject <IMachineLearningWorkspacesIdentity>
 -Property <IPrivateEndpointConnection> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
