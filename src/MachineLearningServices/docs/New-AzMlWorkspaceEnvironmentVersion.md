...
```
New-AzMlWorkspaceEnvironmentVersion -Name <String> -ResourceGroupName <String> -Version <String>
 -WorkspaceName <String> -Body <IEnvironmentVersionData> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzMlWorkspaceEnvironmentVersion -InputObject <IMachineLearningWorkspacesIdentity>
 -Body <IEnvironmentVersionData> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.IEnvironmentVersionData
...
BODY <IEnvironmentVersionData>: Azure Resource Manager resource envelope.
  ...
  - `[BuildContextUri <String>]`: URI of the Docker build context used to build the image. Supports blob URIs on environment creation and may return blob or Git URIs.         <seealso href="https://docs.docker.com/engine/reference/commandline/build/#extended-description" />
  ...
  - `[LivenessRoutePath <String>]`: The path for the route.
  - `[LivenessRoutePort <Int32?>]`: The port for the route.
  - `[OSType <OperatingSystemType?>]`: The OS type of the environment.
  - `[ReadinessRoutePath <String>]`: The path for the route.
  - `[ReadinessRoutePort <Int32?>]`: The port for the route.
  - `[ResourceBaseProperty <IResourceBaseProperties>]`: The asset property dictionary.
    - `[(Any) <String>]`: This indicates any property can be added to this object.
  - `[ScoringRoutePath <String>]`: The path for the route.
  - `[ScoringRoutePort <Int32?>]`: The port for the route.
