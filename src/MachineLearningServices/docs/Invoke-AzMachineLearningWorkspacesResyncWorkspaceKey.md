...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/invoke-azmachinelearningworkspacesresyncworkspacekey
schema: 2.0.0
---

# Invoke-AzMachineLearningWorkspacesResyncWorkspaceKey
...
### Resync (Default)
```
Invoke-AzMachineLearningWorkspacesResyncWorkspaceKey -ResourceGroupName <String> -WorkspaceName <String>
...
### ResyncViaIdentity
```
Invoke-AzMachineLearningWorkspacesResyncWorkspaceKey -InputObject <IMachineLearningWorkspacesIdentity>
