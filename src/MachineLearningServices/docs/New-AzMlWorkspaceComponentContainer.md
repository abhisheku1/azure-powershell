...
```
New-AzMlWorkspaceComponentContainer -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 -Body <IComponentContainerData> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-AzMlWorkspaceComponentContainer -InputObject <IMachineLearningWorkspacesIdentity>
 -Body <IComponentContainerData> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.IComponentContainerData
...
BODY <IComponentContainerData>: Azure Resource Manager resource envelope.
