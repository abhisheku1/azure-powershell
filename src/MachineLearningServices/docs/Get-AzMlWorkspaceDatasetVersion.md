...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/get-azmlworkspacedatasetversion
schema: 2.0.0
---

# Get-AzMlWorkspaceDatasetVersion
...
### List (Default)
```
Get-AzMlWorkspaceDatasetVersion -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### Get
```
Get-AzMlWorkspaceDatasetVersion -Name <String> -ResourceGroupName <String> -Version <String>
 -WorkspaceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMlWorkspaceDatasetVersion -InputObject <IMachineLearningWorkspacesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
