...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/get-azmachinelearningworkspacescompute
schema: 2.0.0
---

# Get-AzMachineLearningWorkspacesCompute
...
### List (Default)
```
Get-AzMachineLearningWorkspacesCompute -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-Skip <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMachineLearningWorkspacesCompute -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMachineLearningWorkspacesCompute -InputObject <IMachineLearningWorkspacesIdentity>
