...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/remove-azmlworkspacedatasetversion
schema: 2.0.0
---

# Remove-AzMlWorkspaceDatasetVersion
...
### Delete (Default)
```
Remove-AzMlWorkspaceDatasetVersion -Name <String> -ResourceGroupName <String> -Version <String>
...
### DeleteViaIdentity
```
Remove-AzMlWorkspaceDatasetVersion -InputObject <IMachineLearningWorkspacesIdentity>
