...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/set-azmlworkspacedatacontainer
schema: 2.0.0
---

# Set-AzMlWorkspaceDataContainer
...
```
Set-AzMlWorkspaceDataContainer -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
```
Set-AzMlWorkspaceDataContainer -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 -Body <IDataContainer> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20220501.IDataContainer
...
BODY <IDataContainer>: Azure Resource Manager resource envelope.
