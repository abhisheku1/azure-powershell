...
```
New-AzMlWorkspaceDatasetVersion -InputObject <IMachineLearningWorkspacesIdentity> -Body <IDatasetVersionData>
...
New-AzMlWorkspaceDatasetVersion -Name <String> -ResourceGroupName <String> -Version <String>
 -WorkspaceName <String> -Body <IDatasetVersionData> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
...
```
New-AzMlWorkspaceDatasetVersion -InputObject <IMachineLearningWorkspacesIdentity> -Path <IUriReference[]>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.IDatasetVersionData
...
BODY <IDatasetVersionData>: Azure Resource Manager resource envelope.
