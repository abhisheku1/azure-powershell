...
### CreateViaIdentity
```
New-AzMlWorkspaceModelVersion -InputObject <IMachineLearningWorkspacesIdentity> -Body <IModelVersion>
...
New-AzMlWorkspaceModelVersion -InputObject <IMachineLearningWorkspacesIdentity> [-Description <String>]
 [-Flavor <Hashtable>] [-IsAnonymou] [-IsArchived] [-JobName <String>] [-ModelType <String>]
