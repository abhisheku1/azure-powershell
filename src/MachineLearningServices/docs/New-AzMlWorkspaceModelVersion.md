...
```
New-AzMlWorkspaceModelVersion -Name <String> -ResourceGroupName <String> -Version <String>
 -WorkspaceName <String> -Body <IModelVersionData> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzMlWorkspaceModelVersion -InputObject <IMachineLearningWorkspacesIdentity> -Body <IModelVersionData>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzMlWorkspaceModelVersion -InputObject <IMachineLearningWorkspacesIdentity> [-Description <String>]
 [-Flavor <Hashtable>] [-IsAnonymou] [-IsArchived] [-JobName <String>] [-ModelFormat <ModelFormat>]
 [-ModelUri <String>] [-ResourceBaseProperty <Hashtable>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.IModelVersionData
...
BODY <IModelVersionData>: Azure Resource Manager resource envelope.
  ...
  - `[ModelFormat <ModelFormat?>]`: The storage format for this entity. Used for NCD.
