...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/set-azmlworkspacebatchendpoint
schema: 2.0.0
---

# Set-AzMlWorkspaceBatchEndpoint
...
```
Set-AzMlWorkspaceBatchEndpoint -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
