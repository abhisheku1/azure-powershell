...
```
New-AzMlWorkspaceEnvironmentContainer -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 -Body <IEnvironmentContainer> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-AzMlWorkspaceEnvironmentContainer -InputObject <IMachineLearningWorkspacesIdentity>
 -Body <IEnvironmentContainer> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20220501.IEnvironmentContainer
...
### Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20220501.IEnvironmentContainer
...
BODY <IEnvironmentContainer>: Azure Resource Manager resource envelope.
