...
online version: https://docs.microsoft.com/powershell/module/az.machinelearningworkspaces/new-azmlworkspaceenvironmentcontainer
schema: 2.0.0
---
...
```
New-AzMlWorkspaceEnvironmentContainer -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 -Body <IEnvironmentContainerData> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzMlWorkspaceEnvironmentContainer -InputObject <IMachineLearningWorkspacesIdentity>
 -Body <IEnvironmentContainerData> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.IEnvironmentContainerData
...
### Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Models.Api20211001.IEnvironmentContainerData
...
BODY <IEnvironmentContainerData>: Azure Resource Manager resource envelope.
