...
// ------------------------------------------------------------------------------
namespace Microsoft.Azure.PowerShell.Cmdlets.Mg.Custom
{
    using System;
    ...
    public partial class ListCmdlet : global::System.Management.Automation.PSCmdlet
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Mg.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"The page size of results.",
        PossibleTypes = new[] { typeof(int) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Mg.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Mg.ParameterCategory.Runtime)]
