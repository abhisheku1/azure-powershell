...
online version: https://docs.microsoft.com/powershell/module/az.resources/new-azmgserviceprincipal
schema: 2.0.0
---

# New-AzMgServicePrincipal
...
```
New-AzMgServicePrincipal [-AccountEnabled] [-AddIn <IMicrosoftGraphAddIn[]>]
...
### Create
```
New-AzMgServicePrincipal -BodyParameter <IMicrosoftGraphServicePrincipal> [-DefaultProfile <PSObject>]
