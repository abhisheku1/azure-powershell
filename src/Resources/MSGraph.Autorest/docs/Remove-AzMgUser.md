...
### Delete (Default)
```
Remove-AzMgUser -Id <String> [-IfMatch <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMgUser -InputObject <IMgIdentity> [-IfMatch <String>] [-DefaultProfile <PSObject>] [-PassThru]
