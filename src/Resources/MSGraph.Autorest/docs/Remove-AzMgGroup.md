...
### Delete (Default)
```
Remove-AzMgGroup -Id <String> [-IfMatch <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMgGroup -InputObject <IMgIdentity> [-IfMatch <String>] [-DefaultProfile <PSObject>] [-PassThru]
