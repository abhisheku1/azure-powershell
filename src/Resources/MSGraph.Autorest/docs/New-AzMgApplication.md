...
```
New-AzMgApplication [-AddIn <IMicrosoftGraphAddIn[]>] [-AdditionalProperties <Hashtable>]
 [-Api <IMicrosoftGraphApiApplication>] [-AppId <String>] [-ApplicationTemplateId <String>]
 [-AppRole <IMicrosoftGraphAppRole[]>] [-CreatedDateTime <DateTime>]
...
### Create
```
New-AzMgApplication -BodyParameter <IMicrosoftGraphApplication> [-DefaultProfile <PSObject>] [-Confirm]
