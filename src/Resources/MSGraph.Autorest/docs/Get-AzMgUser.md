...
### GetViaIdentity
```
Get-AzMgUser -InputObject <IMgIdentity> [-Expand <String[]>] [-Select <String[]>] [-ConsistencyLevel <String>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Mg.Models.ApiV10.IMicrosoftGraphUser
