...
### List (Default)
```
Get-AzMgApplication [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>] [-Search <String>]
...
### Get
```
Get-AzMgApplication -Id <String> [-Expand <String[]>] [-Select <String[]>] [-ConsistencyLevel <String>]
...
### GetViaIdentity
```
Get-AzMgApplication -InputObject <IMgIdentity> [-Expand <String[]>] [-Select <String[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Mg.Models.ApiV10.IPaths1Hl8AmeApplicationsMicrosoftGraphGetbyidsPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get1
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Mg.Models.ApiV10.IPaths1Hl8AmeApplicationsMicrosoftGraphGetbyidsPostRequestbodyContentApplicationJsonSchema
