...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.PowerShell
{
    ...
    {
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SendAsyncStep Wrap(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SendAsyncStep func);
        System.Collections.Generic.IEnumerable<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SendAsyncStep> funcs);
    ...
    public class AsyncCommandRuntime : System.Management.Automation.ICommandRuntime2, IAsyncCommandRuntimeExtensions, System.IDisposable
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SendAsyncStep Wrap(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SendAsyncStep func) => func.Target.GetType().Name != "Closure" ? func : (p1, p2, p3) => ExecuteSync<System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage>>(() => func(p1, p2, p3));
        public System.Collections.Generic.IEnumerable<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SendAsyncStep> funcs) => funcs?.Select(Wrap);
