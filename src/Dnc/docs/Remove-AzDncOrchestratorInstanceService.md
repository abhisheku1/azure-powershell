...
external help file:
Module Name: Az.Dnc
online version: https://docs.microsoft.com/powershell/module/az.dnc/remove-azdncorchestratorinstanceservice
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzDncOrchestratorInstanceService -InputObject <IDncIdentity> [-DefaultProfile <PSObject>] [-AsJob]
